    ...
    <section class="hero">
      <div class="hero-body">
        <div class="container">
          ...
          <div class="is-two-thirds colunm is-paddingless">
            <h2 class="substitle is-4">{{subheading}}</h2>
          </div>
...
export default {
  ...
  data(){
    return{
      ...
      subheading: 'Soaring to new heights Soaring to new heights Soaring to new heights'
    }
  }
}
</script>
